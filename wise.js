...
var files=[] ;var wise=[];
function loadFile(name){return files[name] ;}
function writeFile(name,content){files[name] =content;} 
...
Array.prototype.script = function(wonstr){swon.text=wonstr; var result=""; var ok="";
...
String.prototype.afterLast =function (a){var s=this; if (s.lastIndexOf(a)>-1)return s.substring(s.lastIndexOf(a)+a.length);else return empty;}
